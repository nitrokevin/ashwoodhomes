...
function avidd_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'event_default_image', array(
		...
		$wp_customize->add_control( "global_link", array(
			'label'   => __( 'Global Link', 'avidd' ),
			'section'         => 'default_content_section',
			'type'            => 'url',

		));

			$wp_customize->add_setting( "registration_link", array(
			'default'           => '',
			'sanitize_callback' => 'esc_url_raw',
		));
		$wp_customize->add_control( "registration_link", array(
			'label'   => __( 'Registration Link', 'avidd' ),
			'section'         => 'default_content_section',
			'type'            => 'url',

		));

				$wp_customize->add_setting( "main_site_link", array(
			'default'           => '',
			'sanitize_callback' => 'esc_url_raw',
		));
		$wp_customize->add_control( "main_site_link", array(
			'label'   => __( 'Main Site', 'avidd' ),
			'section'         => 'default_content_section',
			'type'            => 'url',
