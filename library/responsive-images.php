...
add_image_size( 'featured-small', 800, 800, true ); // name, width, height, crop
add_image_size( 'featured-medium', 1280, 600, true );
add_image_size( 'featured-large', 1440, 650, true );
add_image_size( 'featured-xlarge', 1920, 900, true );
